...
interface IL10N {
	...
	/**
	 * Translating
	 * @param non-empty-string $text_singular the string to translate for exactly one object
	 * @param non-empty-string $text_plural the string to translate for n objects
